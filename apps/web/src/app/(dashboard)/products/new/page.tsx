      ...
      <Card className="max-w-2xl p-6">
        ...
        {step === 4 && product ? (
          <div className="space-y-4">
            <SectionTitle hint="where real product output comes from">Connector</SectionTitle>
            ...
            <form action={saveConnector} className="space-y-4">
              ...
              <div className="space-y-2">
                {[
                  ['mcp', 'MCP server', 'The product exposes tools over MCP, as RecipeFix does. The richest option: real output, real numbers.'],
                  ...
                  ['none', 'None', 'Fully supported. Ideas come from the brief, signals and your own input; nothing tries to pull product output.'],
                ].map(([value, label, why]) => (
                  <label
                    key={value}

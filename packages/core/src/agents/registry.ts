...
export const AGENT_REGISTRY: AgentContract[] = [
  ...
  },
  {
    ...
    declaredStatus: 'blocked',
    statusNote:
      'BLOCKED ON PROCUREMENT: music_beds ships empty and reports why it is silent rather than substituting. Selection, ducking and licence gating are done and tested.',
  },
  {
